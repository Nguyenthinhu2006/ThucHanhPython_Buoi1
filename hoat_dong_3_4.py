...
"""
Trong trường hợp tính lũy thừa, và cho kết quả giống nhau vì cả hai đều thực hiện phép tính mũ .
Tuy nhiên, hàm còn có thể nhận thêm tham số thứ ba để tính lũy thừa theo modulo, ví dụ , trong khi toán tử không có cách viết tương đương trực tiếp với ba tham số như vậy.
pow(c, 2)c ** 2c2pow()pow(a, b, m)
"""
import math
a, b, c = 1, -3, 2
delta = b ** 2 - 4 * a * c
